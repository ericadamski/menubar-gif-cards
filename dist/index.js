process.env.HMR_PORT=56643;process.env.HMR_HOSTNAME="";// modules are defined as an array
...
const mb = exports.mb = (0, _menubar2.default)({
    dir: __dirname + '/../',
    preloadWindow: true,
    height: 640,
    width: 560
...
let appLauncher = new _autoLaunch2.default({ name: process.env.APP_SLUG });
